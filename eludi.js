...
tbody.removeChild(tbody.lastChild);
			...
			var NombreScores=["Carritos4U","Forsaken","KodeX Club","CYANTIC","Die Sweeten","AlfaGaming","Portaceli","PolloZ","EpicLegends","Distance"];	
			var ScoresScores=["17690","17675","17454","17342","16734","16232","15678","15345","14568","14234"];	
			var DatesScores=["12/04/2014","03/01/2013","23/06/2014","14/07/2013","09/02/2013","09/03/2013","14/05/2014","03/04/2014","06/07/2013","19/10/2014"];	
			...
			for (var i = 0; i < 10; ++i) {
				...
				tr.appendChild(document.createElement('td'));
				tr.childNodes[tr.childNodes.length-1].innerHTML=ScoresScores[i];
				tr.appendChild(document.createElement('td'));
				tr.childNodes[tr.childNodes.length-1].innerHTML=NombreScores[i];
				tr.appendChild(document.createElement('td'));
				tr.childNodes[tr.childNodes.length-1].innerHTML= DatesScores[i];
